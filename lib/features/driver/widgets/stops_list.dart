    ...
    return AnimatedContainer(
      ...
      child: Dismissible(
        ...
        confirmDismiss: (direction) async {
          IOSTheme.success();
          onTap(); // This will trigger the completion flow
          return false; // Don't actually remove from list immediately, wait for backend success
        },
        child: IOSCard(
          onTap: onTap,
                ...
                children: [
                  ...
                  Expanded(
                    child: _ActionButton(
                      ...
                      label: 'Доставлено',
                      backgroundColor: IOSTheme.systemGreen.withOpacity(0.1),
                      color: IOSTheme.systemGreen,
                      onTap: () {
                        IOSTheme.success();
                        onTap();
...
class _ActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg = backgroundColor ?? IOSTheme.fill.withOpacity(0.05);
