    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(
            child: BlocBuilder<DriverApiBloc, DriverApiState>(
          ...
          // Current Route Card (from API)
          SliverToBoxAdapter(
            child: BlocBuilder<DriverApiBloc, DriverApiState>(
              builder: (context, driverState) {
                final stops = driverState.stops;
                final pendingStops = stops.where((s) => s.isPending).toList();
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            nextStop != null
                                ? 'Следующий: ${nextStop.customerName}'
                                : stops.isEmpty
                                    ? 'Нет заказов'
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  nextStop?.address ?? 'Нет активных доставок',
