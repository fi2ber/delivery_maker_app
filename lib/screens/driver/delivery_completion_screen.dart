                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                color: isActive ? IOSTheme.labelPrimary : IOSTheme.labelSecondary,
                              ),
                              textAlign: TextAlign.center,
                            ),
                          ],
                      ...
                      if (index < _steps.length - 1)
                        Expanded(
                          child: Container(
                            height: 2,
                            color: isCompleted ? IOSTheme.systemGreen : IOSTheme.bgSecondary,
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    disabledForegroundColor: IOSTheme.labelQuaternary,
                    elevation: 0,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(16),
                    ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.location_on_outlined, size: 18, color: IOSTheme.systemBlue),
                ...
                Row(
                  children: [
                    const Icon(Icons.shopping_bag_outlined, size: 18, color: IOSTheme.systemGreen),
                    const SizedBox(width: 8),
                    Text(
                      '${order.items} товаров',
                      style: TextStyle(
          ...
          if (hasPhoto) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: IOSTheme.systemGreen.withOpacity(0.1),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(color: IOSTheme.systemGreen, width: 2),
              ),
              child: Center(
                child: Column(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(icon, color: IOSTheme.systemBlue, size: 28),
            ),
            const SizedBox(height: 12),
            Text(
              labelPrimary,
          ...
          if (hasSignature) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: IOSTheme.systemGreen.withOpacity(0.1),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: IOSTheme.systemGreen),
              ),
              child: const Row(
                children: [
                  Icon(Icons.check_circle, color: IOSTheme.systemGreen),
                  SizedBox(width: 12),
                  Expanded(
                    child: Text(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: isSelected ? IOSTheme.systemBlue.withOpacity(0.1) : Colors.white,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected ? IOSTheme.systemBlue : Colors.transparent,
            width: 2,
          ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(
                icon,
                color: isSelected ? IOSTheme.systemBlue : IOSTheme.systemBlue,
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 17,
                      color: isSelected ? IOSTheme.systemBlue : IOSTheme.labelPrimary,
                    ),
                  ),
                  const SizedBox(height: 4),
                  Text(
